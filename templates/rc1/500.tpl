...
<html lang="en">
    <head>
        ...
        <title>RadioCloud :: Error 500 </title>
                ...
                <div class="error-full-page">
                    ...
                    <div class="col-sm-12 page-error pad-30">
                        ...
                        <div class="error-details col-sm-6 col-sm-offset-3">
                            <h3> 500 errori </h3>
                            <p> Zoixonak, Radixuko pin bat zeutzat!
                                <br> Jarri geuaz kontaktun, info@radixu.info
                                <br>
                                <a href="index.php" class="btn btn-danger btn-return"> <i class="fa fa-home"> </i> Atzin hobeto neuan </a>
                            </p>
                        </div>
                    </div>
                    <!-- end: 404 -->
