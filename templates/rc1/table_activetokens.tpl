                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Aktibo dauden tokenak</h3>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 text-xs-center">
                                                <div class="form-group">
                                                    <button onclick="location.href='?m=configuration&c=tokens&expireAllTokens=1';"  class="btn btn-danger">Itxi saio guztiak</button>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function del_token(id) {
        $(location).attr('href', 'index.php?m=configuration&c=tokens&delToken='+id);
    }
